...
class Project extends Component {
    ...
    handleInfo = () => {  /* fonction qui permet de rendre vrai ou faux showinfo */
        this.setState({
    ...
    render() {
        let {name, languagesIcons, source, info, picture, backend} = this.props.item;
        return (
